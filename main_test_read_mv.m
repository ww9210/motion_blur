...
for begin_of_frames=24:48
   ...
   % save(strcat('./motion_vector_',int2str(frame),'_frame'),'motion_current','frame_current_prediction');
     read(strcat('./motion_vector_',int2str(begin_of_frames),'_frame'));
    ...
    str = strcat('./Result/frame:',num2str(begin_of_frames),'_',datestr(now),'_blurring_info.txt');
