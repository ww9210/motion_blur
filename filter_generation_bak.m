function [filter_optimized, rest_error] = filter_generation_bak(original, target, M, N)
...
%% row 2 f(-l,0)
    for l=1:M-2
        left_akf(2,1) = left_akf(2,1)+korrelation(original,original,M,N,-l,0,blocksize,0,0);
        for i=1:M-2 
...
%% row 3 f(-M+1,0)
left_akf(3,1) = korrelation(original,original,M,N,-M+1,0,blocksize,0,0);
for i=1:M-2 
    left_akf(3,2) = left_akf(3,2)+korrelation(original,original,M,N,-M+1,0,blocksize,-i,0);
end
...
%% row 4 f(0,-p)
for p=1:N-2
    left_akf(4,1) = left_akf(4,1)+korrelation(original,original,M,N,0,-p,blocksize,0,0);
    for i=1:M-2 
        left_akf(4,2) = left_akf(4,2)+korrelation(original,original,M,N,0,-p,blocksize,-i,0);
    end
    left_akf(4,3) = left_akf(4,3)+korrelation(original,original,M,N,0,-p,blocksize,-M+1,0);
    for j=1:N-2
...
for l=1:M-2
    for p=1:N-2
        left_akf(5,1) = left_akf(5,1)+korrelation(original,original,M,N,-l,-p,blocksize,0,0);
        for i=1:M-2 
            left_akf(5,2) = left_akf(5,2)+korrelation(original,original,M,N,-l,-p,blocksize,-i,0);
        end
        left_akf(5,3) = left_akf(5,3)+korrelation(original,original,M,N,-l,-p,blocksize,-M+1,0);
        for j=1:N-2
            left_akf(5,4) = left_akf(5,4)+korrelation(original,original,M,N,-l,-p,blocksize,0,-j);
        end
        for i=1:M-2
            for j=1:N-2
...
for p=1:N-2
    left_akf(6,1) = left_akf(6,1)+korrelation(original,original,M,N,-M+1,-p,blocksize,0,0);
    for i=1:M-2 
        left_akf(6,2) = left_akf(6,2)+korrelation(original,original,M,N,-M+1,-p,blocksize,-i,0);
    end
    left_akf(6,3) = left_akf(6,3)+korrelation(original,original,M,N,-M+1,-p,blocksize,-M+1,0);
    for j=1:N-2
        left_akf(6,4) = left_akf(6,4)+korrelation(original,original,M,N,-M+1,-p,blocksize,0,-j);
    end
    for i=1:M-2
        for j=1:N-2
            left_akf(6,5) = left_akf(6,5)+korrelation(original,original,M,N,-M+1,-p,blocksize,-i,-j);
        end
    end
    for j=1:N-2 
...
left_akf(7,1) = korrelation(original,original,M,N,0,-N+1,blocksize,0,0);
for i=1:M-2 
    left_akf(7,2) = left_akf(7,2)+korrelation(original,original,M,N,0,-N+1,blocksize,-i,0);
end
left_akf(7,3) = korrelation(original,original,M,N,0,-N+1,blocksize,-M+1,0);
for j=1:N-2
    left_akf(7,4) = left_akf(7,4)+korrelation(original,original,M,N,0,-N+1,blocksize,0,-j);
end
for i=1:M-2
    for j=1:N-2
        left_akf(7,5) = left_akf(7,5)+korrelation(original,original,M,N,0,-N+1,blocksize,-i,-j);
    end
end
for j=1:N-2 
    left_akf(7,6) = left_akf(7,6)+korrelation(original,original,M,N,0,-N+1,blocksize,-M+1,-j);
end
...
for l=1:M-2
    left_akf(8,1) = left_akf(8,1)+korrelation(original,original,M,N,-l,-N+1,blocksize,0,0);
    for i=1:M-2 
        left_akf(8,2) = left_akf(8,2)+korrelation(original,original,M,N,-l,-N+1,blocksize,-i,0);
    end
    left_akf(8,3) = left_akf(8,3)+korrelation(original,original,M,N,-l,-N+1,blocksize,-M+1,0);
    for j=1:N-2
        left_akf(8,4) = left_akf(8,4)+korrelation(original,original,M,N,-l,-N+1,blocksize,0,-j);
    end
    for i=1:M-2
        for j=1:N-2
            left_akf(8,5) = left_akf(8,5)+korrelation(original,original,M,N,-l,-N+1,blocksize,-i,-j);
        end
    end
    for j=1:N-2 
        left_akf(8,6) = left_akf(8,6)+korrelation(original,original,M,N,-l,-N+1,blocksize,-M+1,-j);
    end
    left_akf(8,7) = left_akf(8,7)+korrelation(original,original,M,N,-l,-N+1,blocksize,0,-N+1);
    for i=1:M-2
...
left_akf(9,1) = korrelation(original,original,M,N,-M+1,-N+1,blocksize,0,0);
for i=1:M-2 
    left_akf(9,2) = left_akf(9,2)+korrelation(original,original,M,N,-M+1,-N+1,blocksize,-i,0);
end
left_akf(9,3) = korrelation(original,original,M,N,-M+1,-N+1,blocksize,-M+1,0);
for j=1:N-2
    left_akf(9,4) = left_akf(9,4)+korrelation(original,original,M,N,-M+1,-N+1,blocksize,0,-j);
end
for i=1:M-2
    for j=1:N-2
        left_akf(9,5) = left_akf(9,5)+korrelation(original,original,M,N,-M+1,-N+1,blocksize,-i,-j);
    end
end
for j=1:N-2 
    left_akf(9,6) = left_akf(9,6)+korrelation(original,original,M,N,-M+1,-N+1,blocksize,-M+1,-j);
end
left_akf(9,7) = korrelation(original,original,M,N,-M+1,-N+1,blocksize,0,-N+1);
for i=1:M-2
    left_akf(9,8) = left_akf(9,8)+korrelation(original,original,M,N,-M+1,-N+1,blocksize,-i,-N+1);
end
...
% row 2 
    for p=1:N-2
        left_akf(2,1) = left_akf(2,1)+korrelation(original,original,M,N,0,-p,blocksize,0,0);
        for j=1:N-2 
...
% row 3
    left_akf(3,1) = korrelation(original,original,M,N,0,-N+1,blocksize,0,0);
    for j=1:N-2 
        left_akf(3,2) = left_akf(3,2)+korrelation(original,original,M,N,0,-N+1,blocksize,0,-j);
    end
...
% row 3
    left_akf(3,1) = left_akf(3,1)+korrelation(original,original,M,N,-M+1,0,blocksize,0,0);
    for i=1:M-2
        left_akf(3,2)= left_akf(3,2) + korrelation(original,original,M,N,-M+1,0,blocksize,-i,0);
    end  
...
% row 4
    left_akf(4,1) = left_akf(4,1)+korrelation(original,original,M,N,0,-1,blocksize,0,0);
    for i=1:M-2
        left_akf(4,2)= left_akf(4,2) + korrelation(original,original,M,N,0,-1,blocksize,-i,0);
    end  
    left_akf(4,3) = left_akf(4,3)+korrelation(original,original,M,N,0,-1,blocksize,-M+1,0);
...
% row 5
for l=1:M-2
    left_akf(5,1) = left_akf(5,1)+korrelation(original,original,M,N,-l,-1,blocksize,0,0);
    for i=1:M-2
        left_akf(5,2)= left_akf(5,2) + korrelation(original,original,M,N,-l,-1,blocksize,-i,0);
    end  
    left_akf(5,3) = left_akf(5,3)+korrelation(original,original,M,N,-l,-1,blocksize,-M+1,0);
    left_akf(5,4) = left_akf(5,4)+korrelation(original,original,M,N,-l,-1,blocksize,0,-1);
    for i=1:M-2
...
% row 6
    left_akf(6,1) = left_akf(6,1)+korrelation(original,original,M,N,-M+1,-1,blocksize,0,0);
    for i=1:M-2
        left_akf(6,2)= left_akf(6,2) + korrelation(original,original,M,N,-M+1,-1,blocksize,-i,0);
    end  
    left_akf(6,3) = left_akf(6,3)+korrelation(original,original,M,N,-M+1,-1,blocksize,-M+1,0);
    left_akf(6,4) = left_akf(6,4)+korrelation(original,original,M,N,-M+1,-1,blocksize,0,-1);
    for i=1:M-2
        left_akf(6,5) = left_akf(6,5)+korrelation(original,original,M,N,-M+1,-1,blocksize,-i,-1);
    end
...
% row 2
    ...
    left_akf(2,1) = left_akf(2,1)+korrelation(original,original,M,N,-1,0,blocksize,0,0);
...
% row 3
for j=1:N-2
    left_akf(3,1) = left_akf(3,1)+korrelation(original,original,M,N,0,-j,blocksize,0,0);
    left_akf(3,2) = left_akf(3,2)+korrelation(original,original,M,N,0,-j,blocksize,-1,0);
    for p=1:N-2    
...
% row 4
for j=1:N-2
    left_akf(4,1) = left_akf(4,1)+korrelation(original,original,M,N,-1,-j,blocksize,0,0);
    left_akf(4,2) = left_akf(4,2)+korrelation(original,original,M,N,-1,-j,blocksize,-1,0);
    for p=1:N-2    
        left_akf(4,3) = left_akf(4,3)+korrelation(original,original,M,N,-1,-j,blocksize,0,-p);
...
% row 5
    left_akf(5,1) = left_akf(5,1)+korrelation(original,original,M,N,0,-N+1,blocksize,0,0);
    left_akf(5,2) = left_akf(5,2)+korrelation(original,original,M,N,0,-N+1,blocksize,-1,0);
    for p=1:N-2    
        left_akf(5,3) = left_akf(5,3)+korrelation(original,original,M,N,0,-N+1,blocksize,0,-p);
        left_akf(5,4) = left_akf(5,4)+korrelation(original,original,M,N,0,-N+1,blocksize,-1,-p);
    end
...
% row 6
    left_akf(6,1) = left_akf(6,1)+korrelation(original,original,M,N,-1,-N+1,blocksize,0,0);
    left_akf(6,2) = left_akf(6,2)+korrelation(original,original,M,N,-1,-N+1,blocksize,-1,0);
    for p=1:N-2    
        left_akf(6,3) = left_akf(6,3)+korrelation(original,original,M,N,-1,-N+1,blocksize,0,-p);
        left_akf(6,4) = left_akf(6,4)+korrelation(original,original,M,N,-1,-N+1,blocksize,-1,-p);
    end
    left_akf(6,5) = left_akf(6,5)+korrelation(original,original,M,N,-1,-N+1,blocksize,0,-N+1);
...
% left
    ...
    left_akf(2,1) = korrelation(original,original,M,N,-1,0,blocksize,0,0);
    ...
    left_akf(3,1) = korrelation(original,original,M,N,0,-1,blocksize,0,0);
    left_akf(3,2) = korrelation(original,original,M,N,0,-1,blocksize,-1,0);
    ...
    left_akf(4,1) = korrelation(original,original,M,N,-1,-1,blocksize,0,0);
    left_akf(4,2) = korrelation(original,original,M,N,-1,-1,blocksize,-1,0);
    left_akf(4,3) = korrelation(original,original,M,N,-1,-1,blocksize,0,-1);
...
% left
    ...
    left_akf(2,1) = korrelation(original,original,M,N,0,-1,blocksize,0,0);
